...
TEST_CASE("`constexpr` viewing support") {
    ...
    static_assert( cfr::views::divisible( range ) );
    
    static_assert( cfr::views::divisible( range ).empty() == false );
    static_assert( cfr::views::divisible( range ).size () == 3     );
    
    static_assert( cfr::views::divisible( range ).front() == 10 );
    static_assert( cfr::views::divisible( range ).back () == 30 );
    
    static_assert( cfr::views::divisible( range )[0] == 10 );
    static_assert( cfr::views::divisible( range )[1] == 20 );
    static_assert( cfr::views::divisible( range )[2] == 30 );
