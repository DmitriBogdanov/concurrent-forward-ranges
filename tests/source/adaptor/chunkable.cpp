...
TEST_CASE( "cfr::views::chunkable / range category" ) {
    ...
    static_assert( std::ranges::random_access_range<decltype( cfr::views::chunkable( range_1    ) )> ); //
    static_assert( std::ranges::bidirectional_range<decltype( cfr::views::chunkable( range_2    ) )> ); //
    static_assert( std::ranges::      forward_range<decltype( cfr::views::chunkable( range_3, 1 ) )> ); // not O( 1 ) sized
...
TEST_CASE( "cfr::views::chunkable / borrowing" ) {
    ...
    static_assert( std::ranges::borrowed_range<decltype( cfr::views::chunkable( range_3, 1 ) )> ); // not O( 1 ) sized
